...
abstract class _LoginStateSuccess implements LoginState {
  const factory _LoginStateSuccess() = _$LoginStateSuccessImpl;
}
...
class _$LoginStateErrorImpl implements _LoginStateError {
...
abstract class _LoginStateError implements LoginState {
  const factory _LoginStateError(final Failure error) = _$LoginStateErrorImpl;
