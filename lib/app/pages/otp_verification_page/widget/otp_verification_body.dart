...
import 'package:bandobast/app/pages/otp_verification_page/cubit/verify_user_state.dart';
...
class OtpVerificationBody extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final lastRequestRef = useRef<VerifyUserRequest?>(null);
        ...
        child: BlocConsumer<VerifyUserCubit, VerifyUserState>(
          listener: (BuildContext context, VerifyUserState state) =>
            ...
            goToProfileSetupPage: () {
              return context.router.replaceAll([const RegisterRoute()]);
            },
            goToDashboard: () {
          ...
          builder: (BuildContext context, VerifyUserState state) =>
              state.maybeWhen(
            ...
            orElse: () => Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    AppElevatedButton(
                      onPressed: otpController.text.length == otpLength
                          ? verifyOtp
                          : null,
