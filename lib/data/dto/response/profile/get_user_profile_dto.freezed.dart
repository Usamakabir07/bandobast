...
class _$GetUserProfileDtoImpl implements _GetUserProfileDto {
  ...
  @override
  String toString() {
    return 'GetUserProfileDto(userId: $userId, name: $name, phone: $phone, cars: $cars, bookings: $bookings, totalWashes: $totalWashes)';
  }
...
abstract class _GetUserProfileDto implements GetUserProfileDto {
  const factory _GetUserProfileDto(
      ...
      @JsonKey(name: DatabaseConstants.totalWashes)
      required final int totalWashes}) = _$GetUserProfileDtoImpl;
